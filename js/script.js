const global = {
    ...
    api: {
      apiKey: '64332fba8c8f829b3f5c6db71653c271',
...
<div class="details-bottom">
  <h2>Movie Info</h2>
  <ul>
    <li><span class="text-secondary">Budget:</span> $${addCommansToNumber(movie.budget)}</li>
    <li><span class="text-secondary">Revenue:</span> $${addCommansToNumber(movie.revenue)}</li>
...
async function search(){
  ...
  if(global.search.term !== '' && global.search.term !== null){
    ...
    if(results.length === 0){
      ...
      document.querySelector('#search_term').value = '';
    console.log(results);
  }else{
